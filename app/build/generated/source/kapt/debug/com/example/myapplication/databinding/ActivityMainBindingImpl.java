...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 4 :
                return onChangeVmWind((androidx.lifecycle.MutableLiveData<java.lang.String>) object, fieldId);
            case 5 :
    ...
    private boolean onChangeVmWind(androidx.lifecycle.MutableLiveData<java.lang.String> VmWind, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x10L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.MutableLiveData<java.lang.String> vmWind = null;
        ...
        java.lang.String vmWindGetValue = null;
        ...
        if ((dirtyFlags & 0x3ffL) != 0) {
            ...
            if ((dirtyFlags & 0x310L) != 0) {
                    ...
                    updateLiveDataRegistration(4, vmWind);


                    if (vmWind != null) {
                        // read vm.wind.getValue()
                        vmWindGetValue = vmWind.getValue();
                    }
            }
        ...
        if ((dirtyFlags & 0x310L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textView8, vmWindGetValue);
        }
    }
